...
The following code gives an example of using a CMIP5 file and some of the R packages and functions discussed. Results include a map of near-surface air temperatures from a single climate model on a specific day in July 2075 (Figure \ref{fig:worldmap}) and a time series of daily near-surface air temperature simulations for the climate model grid point closest to Beijing, China (Figure \ref{fig:timeseries}). To try this example, you will need to download the file "tas_day_GFDL-ESM2G_rcp85_r1i1p1_20710101-20751231.nc" from https://pcmdi.llnl.gov/search/cmip5/ and save it in the "tmp" subdirectory of your home directory.
