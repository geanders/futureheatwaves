...
#'
#' This dataset provides an example of the structure of the dataframe that
#' any heatwave identification function must be able to input. This data
#' can be used to test a custom heatwave function before using the function
...
#' \itemize{
#'    \item hw.number: A sequential number identifying each heatwave in each
#'        community
#'    \item mean.temp: Average of mean daily temperature across all days in the
#'       heatwave
#'    \item max.temp: Highest value of mean daily temperature across days in the
#'       heatwave
#'    \item min.temp: Lowest value of mean daily temperature across days in the
#'       heatwave
...
#'    \item start.doy: Numeric day of the year of the first day of the heatwave
#'       (1 = Jan. 1, etc.)
#'    \item start.month: Numeric value indicating the month in which the
#'        heatwave started (1 = January);
...
#'        percentile temperature for the community
#'    \item first.in.season: Whether the heatwave was the first to occur in its
#'        season (as determined by whether the heatwave was the first in its
#'        calendar year)
#'    \item threshold.temp: The temperature used as the threshold for the
#'        heatwave definition in the selected community
...
#'        temperature distribution, based on the temperatures for the community
...
#'        temperature during the heatwave compared to the community's year-round
#'        temperature distribution
#'    \item mean.temp.1: The community's average year-round temperature, based
#'        on the temperatures for the community during the period specified by
#'        the \code{referenceBoundaries} argument in
#'        \code{\link{gen_hw_set}}
#'    \item mean.summer.temp: The community's average May--September
