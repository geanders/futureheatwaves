...
When using this package, CMIP5 climate model output data requires some pre-processing. Data will need to be saved in a specific format, with files stored in a specific directory structure. Full details of the required file and directory structure are provided in the package's "futureheatwaves" vignette, while tips and an R script for conducting this processing starting from CMIP5 netCDF files are given in the "starting_from_netcdf" vignette.
