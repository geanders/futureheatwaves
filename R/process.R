...
#' heatwaves in the climate projection data using the ensemble member specified
#' by \code{threshold_ensemble} in \code{\link{gen_hw_set}}. This threshold is
#' used in later functions to identify heatwaves.
#'
...
#'
#' This function, for each ensemble member, creates the heatwave dataframe and
...
#'
#' @return This function writes every heatwave dataframe to a .csv and returns
...
#'    the distance between each community given in the
