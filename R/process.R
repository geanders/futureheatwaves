...
processEnsemble <- function(ensemble, experiment, modelName, global, custom, reference){
...
# ~~findClosest~~
# Find closest point of measurement in latlong to the city using the pythagorean theorem
#
# Precondition: A vector containing the name of a city, it's latitude, and it's longitude in that order; A dataframe of latitude and
# longitude pairings with latitudes in the first column and longitudes in the second column.
#
# Postcondition: An index corresponding to the coordinates in the dataframe that is closest to the city coordinates.
...
# -customizeizable
#
# Precondition: A dataframe containing the cmip5 date data. A string specifying the experiment
#
# Postcondition: A vector containing an upper bound of the experiment time period as an index;
# the lower bound of the experiment time period as an index; and the number of days spanned.
...
# Consolidate components of the dates from the times data frame into one vector

# ~~formDates~~
# Acquire the dates spanning the desired time period of the ensemble
#
# Precondition: A data frame containing the time data for one of the cmip5 ensembles; the desired time boundaries of the ensemble.
#
# Postcondition: A vector of dates formatted as year-month-day (xxxx-x-xx) spanning the desired time boundaries.
