...
The other new mapping function, `map_grid_leaflet`, allows you to create interactive maps using the `leaflet` package and will also work for study cities anywhere. This function adds pop-ups labeling city locations and climate model grid point locations. The map, like any leaflet map, allows panning and zooming. 
