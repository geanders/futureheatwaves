...
#' heatwave and giving separate numbers to identify each discrete heatwave.
#'
...
#'    (0 : not part of a heatwave / 1: part of a heatwave); and
#'    \code{hw.number}: if it was part of a heatwave, the number of the
#'    heatwave (1, 2, etc.).
#'
