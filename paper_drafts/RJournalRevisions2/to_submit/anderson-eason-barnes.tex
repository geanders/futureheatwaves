...
package (\CRANpkg{ncdf4.helpers}; \citet{ncdf4helpers}) already provides
...
\pkg{ncdfFlow} enables R users to conduct analyses of hundreds of large
flow cytometry output files through the creation and use of an
\code{ncdfFlowSet} class that stores the data in an HDF5 format rather
