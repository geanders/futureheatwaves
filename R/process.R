...
#'    path to the input climate projections, the dataframe withcity
#'    locations).
...
#'    eachcity included in the user-specifiedcity location
#'    file, with each element value giving the threshold temperature for the
#'    heat wave definition for acity, in the same order thatcities
...
#' @param thresholds A vector with the thresholds to use within eachcity
#'    in thatcity's heat wave definition.These are typically automatically
...
#'    the distance between eachcity given in the
...
#'city based on thecity's latitude and longitude using the
#' Euclidean distance.
#'
