...
Because the resulting plot is a "ggplot" object, you can use `ggplot2` functions to change the formatting for this output. For example, you could change the title and theme with the following code:
