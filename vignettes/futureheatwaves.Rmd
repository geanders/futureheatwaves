...
The historical projections range over the years 1980 to 2005, while the future projections range over the years ...

Here is an example of the first few lines of a `times` file: 
...
Here is an example of the first few lines of a `latlong` file: 
...
Here is an example of the first few lines of a `tas` file for the three grid points that are included in our examples in the package documentation: 
