...
First, you must have a comma-separated (csv) file the gives unique identifiers for each community for which you wish to make projections, as well as their latitude and longitude. This file should have at least three columns, with the following column names: 

- `city`: A unique identifier for each community you will be analyzing.
- `lat`: The communities latitude, in [units]
- `long`: The communities longitude, in [units]
...
```
"city","lat","long"
"balt",39.3008,76.610616
"ny",40.6698,73.943849
"nwk",40.7241,74.173245
"phil",40.006817,75.134678
"prov",41.82195,71.419732
```
...
Once you have created a directory of files with characterized heatwaves for each ensemble member, ...
...
By default, the function will generate heatwave projections for the selected communities for the years 2061 to 2080. This projection date range can be changed by specifying alternative starting and ending years as the third and fourth values of the `dataBoundaries` option in the `gen_hw_set` function. The starting year cannot be earlier than 2006 and the ending year cannot be later than 2099.
